              ...
              <div className="contentq">
                ...
                <p>
                  * 단, 부득이한 경우 발송 정보 입력 기한 이내에 고객센터를 통한
                  협의 및 SCREAM의 사전 승인 하에 상품 동일성 식별이 가능하도록
                ...
                <p>&nbsp;</p>
                <p>
                  SCREAM은 해당 사안의 사실관계, 이전 사용이력, 거래행태 등을
          ...
          >
            <div className="content-block">
              <div className="contentq">
                ...
                <h2>소명자료 접수</h2>
                <p>
                  SCREAM에서는 가품, 손상/오염/사용감 있는 상품으로부터 구매자를
            ...
            <div className="content-block">
              <div className="contentq">
                <p>
                  <br />
                  <br />
                  SCREAM 내 STYLE 서비스는 회원들의 일상 속 스니커즈, 의류 등의
                ...
                <p>
                  ...
                  만들어진 정책입니다. SCREAM을 사용하면 이 가이드라인과
                ...
                <ul>
                  ...
                  <li>
                    회원은 SCREAM의 이용약관에 어긋나지 않는 콘텐츠만을 게시할
                    수 있습니다.
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    SCREAM이 작성한 저작물에 대한 저작권 및 기타 지적재산권은
                    SCREAM에 귀속합니다.
                  </li>
                  <li>
                    ...
                    간주합니다. 또한 SCREAM에 대해 저작인격권을 행사하지 않을
                    것에 동의한 것으로 간주합니다.
                  </li>
                </ul>
                <p>
                ...
                <ul>
                  ...
                  <li>
                    SCREAM은 콘텐츠와 관련한 문제에 대응하고 게시자와 신고자에게
                ...
                <p>
                  ...
                  참고하시어 건강한 커뮤니티를 만들어주세요. SCREAM의 STYLE이
