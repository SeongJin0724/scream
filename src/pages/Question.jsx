    ...
    <Main>
      <div className="notice_container">
        <nav className="notice_nav">
          <a href="/notice" className="notice_nav_title">
            고객센터
          </a>
                ...
                <li
                  className={
                    location.pathname === "/question"
                      ? "notice_shopinfo_sub_li_active"
                      : "notice_shopinfo_sub_li"
                  }
                >
                ...
                <div className="content-block">
                  <div className="contentq">
                    ...
                    <p>
                      ...
                      <a href="https://SCREAM.co.kr/agreement">이용약관</a>
                      &nbsp;제24조("서비스수수료")에 따라 별도의 고지없이
                      재결제를 시도합니다.
                    </p>
                    <p>&nbsp;</p>
                    <h2>
                    ...
                    <p>
                      * 단, 부득이한 경우 발송 정보 입력 기한 이내에 고객센터를
                      통한 협의 및 SCREAM의 사전 승인 하에 상품 동일성 식별이
                      가능하도록 조치한 경우에 한하여 상품 입고가 가능한 점 참고
                      부탁드립니다.&nbsp;
                    </p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    ...
                    <p>&nbsp;</p>
                    <p>
                      SCREAM은 이용약관 제 24조 ("서비스 수수료") 다. 항에 따라
                      회원이 아래와 같은 특별한 사유에 해당하는 것으로
                      객관적으로 소명할 경우 기 부과된 페널티를 감경 또는 면제할
                      수 있습니다.
                    </p>
                    <p>&nbsp;</p>
                    <p>
                      SCREAM은 해당 사안의 사실관계, 이전 사용이력, 거래행태
                      등을 종합적으로 분석하여 아래 사유에 해당하는지 여부를
                      최종 판단합니다.
                    </p>
                    <p>&nbsp;</p>
                    <p>
                      페널티 감경 또는 면제는 해당 회원의 부주의에도 불구하고
                      SCREAM이 회원의 특별한 사정을 고려하여 예외적으로 실시하는
                    ...
                    <ul>
                      ...
                      <li>
                        명백히 택배사의 책임 있는 사유로 인하여 페널티 발생한
                        경우
                      </li>
                      <li>
                        고의성이 없이 가품 및 손상/오염/사용감 있는 제품을
                        판매한 것이 명백한 경우 (단, 페널티 감경이
                        이루어지더라도 가품 및 손상/오염/사용감 있는 제품 판매로
              ...
              >
                <div className="content-block">
                  <div className="contentq">
                    <p>&nbsp;</p>
                    <p>
                      가품 ・ 손상/오염/사용감 있는 상품 판매를 시도하여 적발된
                      경우 판매금액의 15.0% 페널티가 부과되며 판매자는 적발 즉시
                      이용정지 처리됩니다.
                      <br />
                      가품 판매의 경우 상표법 108조에 의거 민사상 손해배상 책임
                      및 형사상 7년 이하의 징역 또는 1억원 이하의 벌금 처벌을
                      받을 수 있습니다. 또한{" "}
                      <a href="https://SCREAM.co.kr/agreement">이용약관</a> 제
                      27조(검수 등) 6항에 따라 가품 판매자는 상표법 등 관계 법령
                      위반 혐의로 수사기관에 신고될 수 있으며, 가품 판정 상품은
                      수사기관 제출, 압수 등으로 인하여 판매자에게 반환되지 않을
                      수 있습니다.
                    </p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <h2>소명자료 접수</h2>
                    <p>
                      SCREAM에서는 가품, 손상/오염/사용감 있는 상품으로부터
                      구매자를 안전하게 보호하고자 해당 제재를 실행하며, 이에
                      따라 선의의 피해자가 발생하지 않도록 소명서 및 관련 자료를
                      고객센터로 전달해주시면 내부 검토를 진행하고 있습니다.
                    </p>
                    <p>&nbsp;</p>
                    <h3>
                ...
                <div className="content-block">
                  <div className="contentq">
                    <p>
                      <br />
                      <br />
                      SCREAM 내 STYLE 서비스는 회원들의 일상 속 스니커즈, 의류
                      등의 패션 스타일을 공유하여 서로 영감을 얻을 수 있는
                      공간입니다. 모두가 건강하고 즐겁게 사용할 수 있는 공간을
                      만들기 위해 함께 노력해주세요.
                    </p>
                    <p>&nbsp;</p>
                    <p>
                      커뮤니티 가이드라인은 서비스를 안전하게 유지하고 보호하기
                      위해 만들어진 정책입니다. SCREAM을 사용하면 이
                      가이드라인과 이용약관에 동의하게 됩니다. 이 가이드라인을
                      위반하는 경우 콘텐츠가 삭제되거나, 계정이 비활성화되는
                      등의 제재를 받을 수 있습니다.
                    </p>
                    <p>
                      <br />
                    ...
                    <ul>
                      <li>
                        커뮤니티 활동이란 회원이 SCREAM의 STYLE 서비스에 사진 및
                        의견을 포함한 콘텐츠를 게시하는 활동입니다.
                      </li>
                      <li>
                        회원의 커뮤니티 활동은 다른 서비스 이용자가 콘텐츠를
                        다운로드하여 열람하거나 개인의 가정에서 비영리적인
                        목적으로 사적 이용하는 것을 허락한 것으로 간주합니다.
                      </li>
                      <li>
                        회원은 SCREAM의 이용약관에 어긋나지 않는 콘텐츠만을
                        게시할 수 있습니다.
                      </li>
                      <li>
                        회원이 서비스 내에 게시하는 게시물은 서비스 및 관련
                        프로모션 등에 노출될 수 있으며, 해당 노출을 위해 필요한
                        범위 내에서는 일부 수정 또는 편집되어 게시될 수
                        있습니다.
                      </li>
                    </ul>
                    <p>
                    ...
                    <p>
                      STYLE에서 권장하는 내용과 형식에 잘 맞는 콘텐츠는 SCREAM
                      운영팀에 의해 수시로 선별되며, 홈의 컬렉션을 통해 노출하게
                      됩니다. 콘텐츠의 내용은 패션 코디 등 일상 속에 바로 적용할
                      수 있거나 영감을 줄 수 있는 내용을 권장합니다.
                    </p>
                    <p>&nbsp;</p>
                    <p>
                      <strong>
                    ...
                    <p>
                      본 커뮤니티 가이드라인에 어긋나는 콘텐츠는 다른 회원들에
                      의해 신고될 수 있으며 별도의 경고 조치 없이 수시로 콘텐츠
                      운영팀에 의해 임시조치될 수 있습니다.
                    </p>
                    <p>&nbsp;</p>
                    <figure class="table">
                      <table>
                        <tbody>
                          ...
                          <tr>
                            <td>
                              • 서비스에 대한 허위 및 오해의 소지가 있는 내용
                            </td>
                            <td>
                              • 개인정보 도용, 사칭 또는 타인의 정보를 무단
                              위변조한 경우
                            </td>
                          </tr>
                          <tr>
                    ...
                    <ul>
                      <li>
                        회원이 서비스 내에 게시한 콘텐츠의 저작권은 해당
                        게시물의 저작자에게 귀속됩니다.
                      </li>
                      <li>
                        회원이 게시한 콘텐츠는 저작권법에 의하여 보호를 받으며,
                        SCREAM이 작성한 저작물에 대한 저작권 및 기타
                        지적재산권은 SCREAM에 귀속합니다.
                      </li>
                      <li>
                        회원은 게시한 콘텐츠의 저작권 및 기타 산업재산권을 갖고
                        있음을 명확히 합니다. 다만 회원은 본 서비스에 콘텐츠를
                        게시함으로써 SCREAM이 서비스 및 사업과 관련하여 해당
                        콘텐츠(및 그 2차적 저작물)의 일부 또는 전부를 전
                        세계적으로 비독점적으로 무상으로 사용할 권리(이용, 공개,
                        반포, 광고, 출판, 복제, 공연, 공중송신, 전시, 배포,
                        대여, 2차 저작물작성)를 허락하며 이를 양도할 수 있음에
                        동의한 것으로 간주합니다. 또한 SCREAM에 대해
                        저작인격권을 행사하지 않을 것에 동의한 것으로
                        간주합니다.
                      </li>
                    </ul>
                    <p>
                    ...
                    <ul>
                      <li>
                        ...
                        있으며 SCREAM은 관련법에 따라 조치를 하여야 합니다.
                        고객센터로 문의하시기 바랍니다.
                      </li>
                      <li>
                        부적절한 콘텐츠에 대한 판단은
                        (사)한국인터넷자율정책기구(KISO)의 정책규정과
                        정보통신망법 제 44조의 7 및 그 상세 기준이 되는
                        정보통신에 관한 심의규정을 참고합니다.
                      </li>
                      <li>
                        SCREAM은 권리자의 요청이 없는 경우라도 권리침해가 인정될
                        만한 사유가 있거나 기타 서비스 운영방침 및 관련법에 따라
                        해당 게시물에 대해 임시조치 등을 취할 수 있습니다
                      </li>
                      <li>
                        SCREAM은 콘텐츠와 관련한 문제에 대응하고 게시자와
                        신고자에게 안내를 진행합니다. 단, 불법, 음란, 성인 관련
                        콘텐츠의 경우 안내 없이 조치합니다.
                      </li>
                      <li>
                        그 외에 서비스의 신뢰도를 떨어뜨리는 콘텐츠 활용 및
                        부적절한 활동이 확인되는 경우, 해당 계정의 활동 전체가
                        제한할 수 있습니다.
                      </li>
                      <li>
                        본인의 게시물이 노출 중단된 경우, 권리침해 사실을 반박할
                        수 있는 소명자료를 통해 재게시 요청이 가능합니다.
                      </li>
                    </ul>
                    <p>
                      <br />
                    ...
                    <p>
                      본 커뮤니티 가이드라인과{" "}
                      <a href="https://SCREAM.co.kr/agreement">이용약관</a>을
                      참고하시어 건강한 커뮤니티를 만들어주세요. SCREAM의
                      STYLE이 최고의 패션 커뮤니티로 성장할 수 있도록 도와주셔서
                      감사합니다.
                    </p>
                    <p>
                      <br />
                    ...
                    <p>
                      문의 사항이 있으신 경우 고객센터 또는 1:1문의하기로
                      문의하시기 바랍니다.
                    </p>
                  </div>
                </div>
